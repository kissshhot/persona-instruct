...
# 指定你的JSON文件路径
file_path = '/home/dyf/data_generate/persona-instruct/data/lima/share_gpt/wo_persona.json'
...
for data in datas:
    if data.get('conversations') and len(data['conversations']) > 0:
        ...
        # 检查content字段是否包含\n\nReason
        if '\n\nReasons' in first_conversation.get('content', ''):
            ...
            output_file = '/home/dyf/data_generate/persona-instruct/data/lima/share_gpt/wo_persona.json'
